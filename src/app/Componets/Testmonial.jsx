            ...
            <div className="max-w-4xl mx-auto relative z-10 text-center">
                ...
                <div className="flex justify-center mb-6 gap-4 items-center">
                    {testimonials.map((t, index) => (
                        <div
                            key={t.id}
                            className={`w-14 h-14 rounded-full overflow-hidden border-2 transition-all duration-300 ${index === current ? 'border-teal-500 scale-110' : 'border-gray-300 opacity-50'
                                }`}
                        >
                            <Image
                                src={t.avatar}
