            ...
            <div className="flex flex-col md:flex-row items-center justify-between">
                ...
                <div className="max-w-4xl space-y-6 ">
                    <p className="text-teal-700 font-semibold flex items-center gap-2 uppercase tracking-wide">
                        <img src="/logo.png" alt="logo" className="h-8 w-8" /> Get to Know Us
                    </p>
                    <h1 className="text-4xl md:text-6xl font-bold "> Driving <br />Excellence <br />Through <br />Evolution & <br />Trust
                    </h1>
                ...
                <div className="relative mt-10 md:mt-0">
                    <div className="rounded-2xl overflow-hidden shadow-xl relative">
                        <div className=" bg-[#008080c0] ">
                            <Image src="/ceoimg.png" alt="CEO" width={400} height={500} className="rounded-2xl object-cover opacity-60" />
                        </div>
